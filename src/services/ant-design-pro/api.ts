...
/** 用户搜索 GET /user/search */
export async function searchUsers(options?: { [key: string]: any },sort?: { [key: string]: any },filter?: { [key: string]: any }) {
  console.log(options)
  return request<API.UserList>('/user/search', {
    method: 'GET',
    params: options,
    ...(options || {}),
  });
